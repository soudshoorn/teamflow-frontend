    ...
    <div className="w-full">
      ...
      <div className="overflow-y-auto max-h-[calc(100vh-250px)] pr-1">
        {isLoading ? (
          ...
          <div className="py-4 px-4 text-sm text-gray-500 bg-gradient-to-b from-gray-50 to-blue-50 rounded-md border border-gray-100 shadow-sm">
            <p className="mb-2">Geen kanalen gevonden.</p>
            <Button
              variant="outline"
              size="sm"
              className="w-full text-xs bg-white hover:bg-blue-50 hover:text-blue-600 border-blue-200"
              onClick={() => setShowAddDialog(true)}
            >
