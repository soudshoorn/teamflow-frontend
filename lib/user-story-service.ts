...
export async function createUserStory(userStory: Omit<UserStory, "id">): Promise<UserStory> {
  ...
  console.log("Creating user story with data:", JSON.stringify(requestData, null, 2))
...
export async function updateUserStory(id: string, userStoryData: Partial<UserStory>): Promise<UserStory> {
  // Converteer van frontend formaat naar backend formaat
  ...
  console.log(`Updating user story ${id} with data:`, JSON.stringify(requestData, null, 2))
